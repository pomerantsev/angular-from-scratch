...
describe('injector', function () {
  ...
  it('does not allow a constant called hsOwnProperty', function () {
    var module = angular.module('myModule', []);
  ...
  it('overrides dependencies with locals whtn invoking', function () {
    var module = angular.module('myModule', []);
    module.constant('a', 1);
    module.constant('b', 2);
    var injector = createInjector(['myModule']);
  ...
  describe('annotate', function () {
    it('returns the $inject anotation of a function when it has one', function () {
      var injector = createInjector([]);
